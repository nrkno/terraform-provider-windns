		...
		p := &schema.Provider{
			Schema: map[string]*schema.Schema{
				...
				"dns_server": {
					Type:        schema.TypeString,
					Optional:    true,
					DefaultFunc: schema.EnvDefaultFunc("WINDNS_DNS_SERVER_HOSTNAME", ""),
